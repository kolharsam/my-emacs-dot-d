;;; package --- init.el
;;; Commentary: This is my emacs config
...
;; this package also requires that we download the indium server `npm i -g indium`
(use-package indium
  :ensure t
...
(global-set-key
 (kbd "M-<left>") 'previous-window)

(global-set-key
 (kbd "C-f") 'find-function)

(global-set-key
 (kbd "C-v") 'find-variable)
